...
const crawlTarget = async (targetUrl) => {
  ...
  try {
    ...
    console.error(
      "Web Crawler fetch failed, using fallback crawler:",
      err.message,
    );
  }
  ...
  if (crawled.length === 0) {
    if (hostname.includes("youtube.com")) {
      crawled.push(
        ...
        {
          path: "/results",
          url: `${targetUrl}/results`,
          params: ["search_query"],
          method: "GET",
        },
        {
          path: "/feed/trending",
          url: `${targetUrl}/feed/trending`,
          params: [],
          method: "GET",
        },
        {
          path: "/channel/about",
          url: `${targetUrl}/channel/about`,
          params: [],
          method: "GET",
        },
        {
          path: "/api/v1/comments",
          url: `${targetUrl}/api/v1/comments`,
          params: ["videoId"],
          method: "POST",
        },
      );
      ...
      crawled.push(
        ...
        {
          path: "/explore",
          url: `${targetUrl}/explore`,
          params: [],
          method: "GET",
        },
        {
          path: "/settings/profile",
          url: `${targetUrl}/settings/profile`,
          params: [],
          method: "POST",
        },
      );
